...
namespace MedicineAPI
{
    public class Startup
    {
        ...
        {
            services.AddTransient<IBaseRepo<User>, BaseRepo<User>>();
            services.AddTransient<IBaseRepo<Items>, BaseRepo<Items>>();
            services.AddTransient<IBaseRepo<Cart>, BaseRepo<Cart>>();
